...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "directoryPicker.newDirectory": "新建目录",
    "directoryPicker.newDirectoryPrompt": "目录名称",
    "directoryPicker.renameDirectoryPrompt": "新的目录名称",
    "directoryPicker.deleteDirectory": "删除目录",
    "directoryPicker.deleteDirectoryConfirm": "删除此目录及其全部内容？",
    "directoryPicker.directoryActions": "目录操作",
    "directoryPicker.confirm": "确认",
    ...
    "files.download": "下载文件",
    "files.edit": "编辑文件",
    "files.save": "保存修改 (Ctrl+S)",
    "files.openInFileManager": "在系统文件管理器中打开目录",
    ...
    "chat.imageInputDisabled": "该模型未开启图片输入，请在模型配置中开启后使用",
    ...
    "chat.reasoningDisabled": "该模型未开启推理 / 思考，请在模型配置中开启后使用",
    ...
    "terminal.toggle": "终端",
    "terminal.close": "关闭终端",
    "terminal.title": "终端 · {shell}",
    "terminal.path": "{path}",
    "terminal.exited": "进程已退出，退出码 {code}",
    "terminal.startError": "无法启动终端",
    "terminal.starting": "正在启动终端…",
    "terminal.new": "新建终端",
    "terminal.tab": "终端 {n}",
    "git.commit": "提交",
    "git.commitPlaceholder": "提交信息（可按需修改）",
    "git.generateCommit": "生成文案",
    "git.generating": "生成中…",
    "git.aiUnavailable": "AI 服务不可达，请稍后重试",
    "git.pull": "拉取",
    "git.push": "推送",
    "git.stage": "暂存",
    "git.unstage": "移出暂存",
