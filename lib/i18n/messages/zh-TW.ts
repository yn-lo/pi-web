...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "files.edit": "編輯檔案",
    "files.save": "儲存修改 (Ctrl+S)",
    "files.openInFileManager": "在系統檔案管理員中開啟目錄",
    ...
    "directoryPicker.newDirectory": "新增目錄",
    "directoryPicker.newDirectoryPrompt": "目錄名稱",
    "directoryPicker.renameDirectoryPrompt": "新的目錄名稱",
    "directoryPicker.deleteDirectory": "刪除目錄",
    "directoryPicker.deleteDirectoryConfirm": "刪除此目錄及其全部內容？",
    "directoryPicker.directoryActions": "目錄操作",
    "directoryPicker.confirm": "確認",
    ...
    "chat.imageInputDisabled": "該模型未開啟圖片輸入，請在模型設定中開啟後使用",
    "chat.reasoningDisabled": "該模型未開啟推理 / 思考，請在模型設定中開啟後使用",
    "terminal.toggle": "終端",
    "terminal.close": "關閉終端",
    "terminal.title": "終端 · {shell}",
    "terminal.path": "{path}",
    "terminal.exited": "程序已結束，結束碼 {code}",
    "terminal.startError": "無法啟動終端",
    "terminal.starting": "正在啟動終端…",
    "terminal.new": "新開終端",
    "terminal.tab": "終端 {n}",
    "git.commit": "提交",
    "git.commitPlaceholder": "提交訊息（可按需修改）",
    "git.generateCommit": "產生文案",
    "git.generating": "產生中…",
    "git.aiUnavailable": "AI 服務無法連線，請稍後再試",
    "git.pull": "拉取",
    "git.push": "推送",
    "git.stage": "暫存",
    "git.unstage": "移出暫存",
    "git.stageAll": "全部暫存",
    "git.stagedSection": "已暫存",
    "git.unstagedSection": "未暫存",
